 ...
 */
public class SpringView2 extends ViewGroup {
    ...
    private boolean bottomEnable = true;
    ...
    public SpringView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void callOnLimitDes() {
        ...
        if (type == Type.OVERLAP) {//重叠
            top = contentView.getTop() >= 0 && isChildScrollToTop();//在顶部
        } else if (type == Type.FOLLOW) {//跟随
    ...
    public void setTopEnable(boolean b) {
        this.topEnable = b;
    }
